  ...
  useEffect(() => {
    ...
    apiFetch(`${API_URL}/api/products/${id}`)
      ...
      .then(data => {
        ...
        setSellingPrice(data.price || data.sellingPrice || "");
        setCostPrice(data.costPrice || "");
        setStock(data.stock || 0);
        setUnit(data.unit || "pcs");
        setAlert(data.restockThreshold || 5);
      ...
      <div className="ap-wrapper">
        <div className="ap-shell">
          ...
          <div className="ap-header">
            ...
            <span className="ap-header-title">Edit Product</span>
          </div>
          ...
          <div className="ap-scroll">
            <div className="ap-content">
              ...
              >
                ...
                ) : isSubmitting ? t.saving : "Save Changes"}
              </button>
          ...
          {saved && (
            <div className="ap-toast">Product updated successfully</div>
          )}
